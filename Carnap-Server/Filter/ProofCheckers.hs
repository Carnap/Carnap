...
activate cls extra chunk
    ...
    | "HausmanSL"        `elem` cls = exTemplate [("system", "hausmanSL"), ("guides","hausman"), ("alternate-symbols","alt3") ]
...
toPlayground cls extra content
    ...
    | "HausmanSL"        `elem` cls = playTemplate [("system", "hausmanSL"), ("guides","hausman"), ("alternate-symbols","alt3")]
