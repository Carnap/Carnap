...
activate cls extra chunk
    ...
    | "GregorySD"        `elem` cls = exTemplate [("system", "gregorySD")]
    | "GregorySDE"       `elem` cls = exTemplate [("system", "gregorySDE")]
    | "GregoryPD"        `elem` cls = exTemplate [("system", "gregoryPD")]
    | "GregoryPDE"       `elem` cls = exTemplate [("system", "gregoryPDE")]
...
toPlayground cls extra content
    ...
    | "GregorySD"        `elem` cls = playTemplate [("system", "gregorySD")]
    | "GregorySDE"       `elem` cls = playTemplate [("system", "gregorySDE")]
    | "GregoryPD"        `elem` cls = playTemplate [("system", "gregoryPD")]
    | "GregoryPDE"       `elem` cls = playTemplate [("system", "gregoryPDE")]
