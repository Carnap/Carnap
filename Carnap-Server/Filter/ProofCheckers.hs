...
activate cls extra chunk
    ...
    | "LogicBookSD"      `elem` cls = exTemplate [("system", "LogicBookSD"), ("guides","fitch"), ("alternate-symbols","alt2") ]
    ...
    | "HausmanSL"        `elem` cls = exTemplate [("system", "hausmanSL"),("alternate-symbols","alt3") ]
...
toPlayground cls extra content
    ...
    | "LogicBookSD"      `elem` cls = playTemplate [("system", "LogicBookSD"), ("guides", "fitch"), ("alternate-symbols","alt2")]
    ...
    | "HausmanSL"        `elem` cls = playTemplate [("system", "hausmanSL"),("alternate-symbols","alt3")]
