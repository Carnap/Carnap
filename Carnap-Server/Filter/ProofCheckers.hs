...
toPlayground cls extra content
    ...
    | "GoldfarbND"       `elem` cls = playTemplate [("system", "goldfarbND")]
    | "GoldfarbAltND"    `elem` cls = playTemplate [("system", "goldfarbAltND")]
    | "GoldfarbNDPlus"   `elem` cls = playTemplate [("system", "goldfarbNDPlus")]
    | "GoldfarbAltNDPlus"`elem` cls = playTemplate [("system", "goldfarbAltNDPlus")]
