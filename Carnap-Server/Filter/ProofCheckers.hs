...
activate cls extra chunk
    ...
    | "HowardSnyderSL"   `elem` cls = exTemplate [("system", "howardSnyderSL"), ("guides","howardSnyder"), ("alternate-symbols","alt3"), ("options", "resize fonts") ]
...
toPlayground cls extra content
    ...
    | "HowardSnyderSL"   `elem` cls = playTemplate [("system", "howardSnyderSL"), ("guides","howardSnyder"), ("alternate-symbols","alt3"), ("options","fonts resize")]
