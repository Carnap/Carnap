...
activate cls chunk
    ...
    | "ZachTFL"          `elem` cls = actTemplate "data-carnap-system=\"thomasBolducAndZachTFL\" data-carnap-options=\"render\""
    | "ZachFOL"          `elem` cls = actTemplate "data-carnap-system=\"thomasBolducAndZachFOL\" data-carnap-options=\"render\""
