...
activate cls extra chunk
    ...
    | "ElementaryST"     `elem` cls = exTemplate [("system", "elementarySetTheory")]
    | "SeparativeST"     `elem` cls = exTemplate [("system", "separativeSetTheory")]
...
toPlayground cls extra content
    ...
    | "ElementaryST"     `elem` cls = playTemplate [("system", "elementarySetTheory")]
    | "SeparativeST"     `elem` cls = playTemplate [("system", "separativeSetTheory")]
