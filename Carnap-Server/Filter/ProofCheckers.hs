...
activate cls extra chunk
    ...
    | "RavenTFL"          `elem` cls = exTemplate [("system", "ravenTFL"), ("options","render")]
    | "RavenTFL2019"      `elem` cls = exTemplate [("system", "ravenTFL2019"), ("options","render")]
    | "RavenTFLCore"      `elem` cls = exTemplate [("system", "ravenTFLCore"), ("options","render")]
    ...
    | "RavenFOL"         `elem` cls = exTemplate [("system", "ravenFOL"), ("options","render")]
    | "RavenFOL2019"     `elem` cls = exTemplate [("system", "ravenFOL2019"), ("options","render")]
    | "RavenFOLCore"     `elem` cls = exTemplate [("system", "ravenFOLCore"), ("options","render")]
    | "RavenFOLPlus2019" `elem` cls = exTemplate [("system", "ravenFOLPlus2019"), ("options","render")]
    | "RavenTFL"         `elem` cls = exTemplate [("system", "ravenTFL"), ("options","render")]
    | "RavenTFL2019"     `elem` cls = exTemplate [("system", "ravenTFL2019"), ("options","render")]
    | "RavenTFLCore"     `elem` cls = exTemplate [("system", "ravenTFLCore"), ("options","render")]
...
toPlayground cls extra content
    ...
    | "RavenTFL"          `elem` cls = playTemplate [("system", "ravenTFL"), ("options","render")]
    | "RavenTFL2019"      `elem` cls = playTemplate [("system", "ravenTFL2019"), ("options","render")]
    | "RavenTFLCore"      `elem` cls = playTemplate [("system", "ravenTFLCore"), ("options","render")]
    ...
    | "RavenFOL"         `elem` cls = playTemplate [("system", "ravenFOL"), ("options","render")]
    | "RavenFOL2019"     `elem` cls = playTemplate [("system", "ravenFOL2019"), ("options","render")]
    | "RavenFOLCore"     `elem` cls = playTemplate [("system", "ravenFOLCore"), ("options","render")]
    | "RavenFOLPlus2019" `elem` cls = playTemplate [("system", "ravenFOLPlus2019"), ("options","render")]
    | "RavenTFL"         `elem` cls = playTemplate [("system", "ravenTFL"), ("options","render")]
    | "RavenTFL2019"     `elem` cls = playTemplate [("system", "ravenTFL2019"), ("options","render")]
    | "RavenTFLCore"     `elem` cls = playTemplate [("system", "ravenTFLCore"), ("options","render")]
