...
activate cls extra chunk
    ...
    | "PaulSD"           `elem` cls = exTemplate [("system", "paulSD")]
    | "PaulSDE"          `elem` cls = exTemplate [("system", "paulSDE")]
    | "PaulPD"           `elem` cls = exTemplate [("system", "paulPD")]
    | "PaulPDE"          `elem` cls = exTemplate [("system", "paulPDE")]
...
toPlayground cls extra content
    ...
    | "PaulSD"           `elem` cls = playTemplate [("system", "paulSD")]
    | "PaulSDE"          `elem` cls = playTemplate [("system", "paulSDE")]
    | "PaulPD"           `elem` cls = playTemplate [("system", "paulPD")]
    | "PaulPDE"          `elem` cls = playTemplate [("system", "paulPDE")]
