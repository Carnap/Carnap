...
instance Inference LogicBookPD PureLexiconFOL (Form Bool) where
         ...
         restriction EE2   = Just (eigenConstraint tau (SS (lsome "v" $ phi' 1) :-: SS (phin 1)) (fogamma 1 :+: fogamma 2)) --Since this one does not use the assumption with a fresh object
